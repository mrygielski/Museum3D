...
//inicjowanei trybu
{
	...
	glClearDepth(1.0f);
	glHint(GL_PERSPECTIVE_CORRECTION_HINT, GL_NICEST);//w³aczanie perspektywy
	glDepthFunc(GL_LEQUAL);
	glEnable(GL_TEXTURE_2D);//w³aczanie tekstur
	glClearColor(0.0, 0.5, 1.0, 0.0);	//czyszczenie buforu na kolor
	glAlphaFunc(GL_GREATER, 0.0f);
	glEnable(GL_ALPHA_TEST);//w³aczanie kana³u alpha
	glEnable(GL_DEPTH_TEST);//w³¹czanie g³êbi
...
GLvoid KillGLWindow(GLvoid)						
//wy³aczanie/zamykanie okna OPENGL
{
	if (fullscreen)									
	{
